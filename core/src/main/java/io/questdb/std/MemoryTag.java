...
public final class MemoryTag {
    ...
    public static final int NATIVE_MQTT_CONN = NATIVE_BIT_SET + 1;
    public static final int SIZE = NATIVE_MQTT_CONN + 1;
    ...
    static {
        ...
        tagNameMap.extendAndSet(NATIVE_MQTT_CONN, "NATIVE_MQTT_CONN");
    }
}

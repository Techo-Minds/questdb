...
public class DecimalSpreadFunctionFactory implements FunctionFactory {
    @Override
    ...
    private static class SpreadFunction extends DecimalFunction implements BinaryFunction {

...
public class PivotRecordCursorFactory extends AbstractRecordCursorFactory {
    ...
    public PivotRecordCursorFactory(RecordCursorFactory base, RecordMetadata unpivotMetadata, int inColumnIndex, int valueColumnIndex, IntList unpivotForIndices, ObjList<CharSequence> unpivotForNames, IntIntHashMap passthroughIndicesMap, boolean includeNulls) {

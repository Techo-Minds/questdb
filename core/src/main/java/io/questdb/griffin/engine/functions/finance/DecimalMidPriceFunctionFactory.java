...
public class DecimalMidPriceFunctionFactory implements FunctionFactory {
    @Override
    ...
    private static class MidPriceFunction extends DecimalFunction implements BinaryFunction {

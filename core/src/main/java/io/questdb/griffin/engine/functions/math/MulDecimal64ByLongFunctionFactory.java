...
public class MulDecimal64ByLongFunctionFactory implements FunctionFactory {
    @Override
    ...
    private static final class Func extends Decimal64Function implements BinaryFunction {
        ...
        public @Decimal long getDecimal64(Record rec) {
            @Decimal long result = Decimal64Impl.mulByInt(left.getDecimal64(rec), right.getLong(rec));

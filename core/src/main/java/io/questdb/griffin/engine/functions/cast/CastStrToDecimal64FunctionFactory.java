...
public class CastStrToDecimal64FunctionFactory implements FunctionFactory {
    @Override
    ...
    private static class Func extends AbstractCastToDecimal64Function {
        ...
        public @Decimal long getDecimal64(Record rec) {
            ...
            try {
                ...
                throw ImplicitCastException.inconvertibleValue(value, ColumnType.STRING, ColumnType.DECIMAL64);
            }
        }
    }
}
